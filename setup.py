...
setup(
    name='causal-feature-learning',  # should it be causal feature learning or CFL? 
    version='0.3.0a1', # version <1.0 indicates 'pre-release' 
    ...
    packages=find_packages(where='cfl'), #TODO: this is wher you do 'find_packages() - did not install subpackages
    package_dir={'': 'cfl'},
